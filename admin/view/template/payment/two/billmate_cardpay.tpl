                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="well well-sm" id="billmatecard-country">
                                ...
                                <div id="billmatecard-country<?php echo $key; ?>"><i class="fa fa-minus-circle"></i> <?php echo $billmate_country['name']; ?>
                                    <input type="hidden" name="billmatecard-country[<?php echo $key;?>][name];?>" value="<?php echo $billmate_country['name']; ?>" />
                                </div>
                                <?php } ?>
                                <?php } ?>
                            </div>
