...
$_['text_no_fee']         = '<img src="billmate/images/bm_faktura_l.png" style="float: left;margin: 2px 6px;" alt="Billmate Invoice">Pay within 14 days  <a id="terms">Terms of invoice</a><script type="text/javascript">$.getScript("https://efinance.se/billmate/base.js", function(){
		$("#terms").Terms("villkor",{invoicefee:0});
});</script>';
$_['text_fee']         = '<img src="billmate/images/bm_faktura_l.png" style="float: left;margin: 2px 6px;" alt="Billmate Invoice">Pay within 14 days  <a id="terms">Terms of invoice</a>  (+%s)<script type="text/javascript">$.getScript("https://efinance.se/billmate/base.js", function(){
