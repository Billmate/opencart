<?php
// Text
$_['text_title_name'] = '<img src="'.(defined('HTTP_IMAGE')?dirname(HTTP_IMAGE) : HTTP_SERVER).'/billmate/images/billmate_bank_s.png" alt="Billmate card">Pay by Bank Transfer.';
