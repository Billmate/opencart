...
$_['text_pay_month']  = 
$_['text_no_fee']     = '<img src="'.(defined('HTTP_IMAGE')?dirname(HTTP_IMAGE) : HTTP_SERVER).'/billmate/images/bm_delbetalning_l.png" alt="Billmate Part Payment" style="margin: 2px 6px;"> Billmate Partpayment - %s (Pay from %s/month) <a id="terms-delbetalning">Terms of part pay</a><script type="text/javascript">$.getScript("https://billmate.se/billmate/base.js", function(){
