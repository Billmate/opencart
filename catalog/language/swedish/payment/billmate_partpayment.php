...
$_['text_pay_month']  = 
$_['text_no_fee']     = '<img src="'.(defined('HTTP_IMAGE')?dirname(HTTP_IMAGE) : HTTP_SERVER).'/billmate/images/bm_delbetalning_l.png" alt="Billmate delbetalning" style="float: left;margin: 2px 6px;">Billmate delbetalning - %s (Betala från %s/månad) <a id="terms-delbetalning">Köpvillkor</a><script type="text/javascript">$.getScript("https://billmate.se/billmate/base.js", function(){
