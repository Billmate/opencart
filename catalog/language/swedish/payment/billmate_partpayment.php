...
$_['text_pay_month']  = 
$_['text_no_fee']     = '<img src="'.(defined('HTTP_IMAGE')?dirname(HTTP_IMAGE) : HTTP_SERVER).'/billmate/images/bm_delbetalning_l.png" alt="Billmate delbetalning"><br><br>Betala från %s/månad <a id="terms-delbetalning">Köpvillkor delbetalning</a><script type="text/javascript">$.getScript("https://efinance.se/billmate/base.js", function(){
