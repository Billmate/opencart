...
}A=i.extend({},A,{boxWidth:F[0]||A.boxWidth,boxHeight:F[1]||A.boxHeight});E=i('<iframe src="'+B.attr("targeturl")+'" name="'+B.attr("targeturl")+'" frameborder="0" scrolling="auto" hspace="0" marginheight="0px" width="'+A.boxWidth+'" height="'+A.boxHeight+'"></iframe>');
